  ...
  const { data: employeeData, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const res = await axios.get(
        `/api/employees/${user.id}?orgId=${user.orgId}`,
      );
  ...
  return (
    <div className="flex-1 p-6 lg:p-10 space-y-8 animate-fade-in max-w-5xl mx-auto w-full">
      ...
      <div className="relative w-full rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
        {/* <div className="h-32 md:h-48 w-full bg-linear-to-r from-blue-600 to-indigo-600 dark:from-blue-900 dark:to-indigo-900"></div> */}

        <div className="p-6 md:p-10 flex flex-col md:flex-row gap-6 relative items-center">
            ...
            <div>
              {isEditing ? (
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, empName: e.target.value })
                  }
              ...
              <p className="text-zinc-500 dark:text-zinc-400 font-medium text-sm md:text-base flex items-center flex-wrap gap-1.5 mt-1">
            ...
            <div className="flex gap-2">
              {isEditing ? (
                ...
                <Button
                  ...
                  className="gap-1.5 border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800"
                >
      ...
      <div className="lg:col-span-2 space-y-6">
        {/* <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label className="text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-1 block">
                Email Address
              </label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <span
                    className={`h-1.5 w-1.5 rounded-full ${employeeData.status === "active" ? "bg-emerald-500" : "bg-red-500"}`}
                  ></span>
